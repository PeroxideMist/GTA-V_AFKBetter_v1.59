...
int main()
{
	...
	const auto MenuWindow = FindWindowA(NULL, "featuring the worst ui of 2022");
	...
	while (TRUE)
	{
		...
		mouse_event(MOUSEEVENTF_LEFTDOWN, 95, 525, 95, 0);
		mouse_event(MOUSEEVENTF_LEFTUP, 95, 525, 0, 0);
